...
!(function (t, e) {
      ...
      (g = {
        ...
        wake: function wake() {
          o &&
            (!n &&
              x() &&
              ((h = n = window), (a = h.document || {}), (ot.gsap = Ee), (h.gsapVersions || (h.gsapVersions = [])).push(Ee.version), P(i || h.GreenSockGlobals || (!h.gsap && h) || {}), (m = h.requestAnimationFrame), Ct.forEach(wb)),
            p && g.sleep(),
            (_ =
              m ||
              function (t) {
  ...
  var Zt = (function (z) {
    function Tween(e, r, i, n) {
      ...
      if (((a._targets = A.length ? ea(A) : R('GSAP target ' + e + ' not found. https://greensock.com', !q.nullTargetWarn) || []), (a._ptLookup = []), (a._overwrite = b), x || T || y(_) || y(m))) {
        if (
          ((r = a.vars), (s = a.timeline = new Xt({ data: 'nested', defaults: k || {}, targets: P && 'nested' === P.data ? P.vars.targets : A })).kill(), (s.parent = s._dp = _assertThisInitialized(a)), (s._start = 0), T || y(_) || y(m))
        ) {
    ...
    return (
      ...
      (e.invalidate = function invalidate(t) {
        return (
          (t && this.vars.runBackwards) || (this._startAt = 0), (this._pt = this._op = this._onUpdate = this._lazy = this.ratio = 0), (this._ptLookup = []), this.timeline && this.timeline.invalidate(t), z.prototype.invalidate.call(this, t)
        );
      }),
  ...
  function xe(t, e, r) {
    var i,
      ...
      l = we({}, r._gsap),
      f = r.style;
    for (n in (l.svg ? ((a = r.getAttribute('transform')), r.setAttribute('transform', ''), (f[dr] = e), (i = kr(r, 1)), Xd(r, dr), r.setAttribute('transform', a)) : ((a = getComputedStyle(r)[dr]), (f[dr] = e), (i = kr(r, 1)), (f[dr] = a)),
    ar))
      (a = l[n]) !== (s = i[n]) &&
        ...
        for (c in (Fe || Sd(), (this.styles = this.styles || Md(t)), (b = this.styles.props), (this.tween = i), e))
          if ('autoRound' !== c && ((o = e[c]), !pt[c] || !ac(c, e, i, n, t, a)))
            if (((l = typeof o), (f = br[c]), 'function' === l && (l = typeof (o = o.call(i, n, t, a))), 'string' === l && ~o.indexOf('random(') && (o = ob(o)), f)) f(this, t, c, o, i) && (T = 1);
              ...
              if (
                (k && c in k
                  ? ((s = 'function' == typeof k[c] ? k[c].call(i, n, t, a) : k[c]), r(s) && ~s.indexOf('random(') && (s = ob(s)), Ya(s + '') || (s += q.units[c] || Ya(yr(t, c)) || ''), '=' === (s + '').charAt(1) && (s = yr(t, c)))
                  : (s = yr(t, c)),
                (h = parseFloat(s)),
                ...
                if (
                  (this.styles.save(c),
                  g || (((v = t._gsap).renderTransform && !e.parseTransform) || kr(t, e.parseTransform), (y = !1 !== e.smoothOrigin && v.smooth), ((g = this._pt = new _e(this._pt, x, dr, 0, 1, v.renderTransform, v, 0, -1)).dep = 1)),
                  'scale' === c)
                )
